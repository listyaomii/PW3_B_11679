...
<html>
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin> <link href="./assets/css/poppins.min.css" rel="stylesheet">
            ...
            <div class="container ">
                        ...
                        <div class="col-md-7 offset-md-5" style="background-color: rgba(0, 0, 0, 0.6); padding: 10px 20px;
                            ...
                            <div>
                                <h2 class="featurette-heading fw-normal">
                                    Restaurant dengan cita rasa <strong>yang fantastis</strong>.
                                </h2>
                                <p class="lead">
                                    Diciptakan oleh <strong>Komang Listya Omi Pradnyani</strong>,
                                    mahasiswa Universitas Atma Jaya Yogyakarta dari program studi Informatika.
                                </p>
                                <p class="lead">Nomor Pokok Mahasiswa: <strong>[220711679]</strong>.</p>
                            </div>
                        </div>
                </div>
                ...
                <div class="row featurette" style="background-image: url('./assets/images/food.jpg');
                        ...
                        <div class="col-md-7" style="background-color: rgba(0, 0, 0, 0.6); padding: 20px; border-radius: 12px; color: white;">
                            ...
                            <p class="lead">
                                Our sophisticated dining space is design to elevate your experience with a curated selection of exquisite dishes,
